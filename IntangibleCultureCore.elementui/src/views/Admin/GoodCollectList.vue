<template>
    <div class="app-container">
        ...
        <el-dialog :title="formData.Id ? '修改文创品收藏' : '添加文创品收藏'" :visible.sync="editorShow" width="50%" :lock-scroll="true"
            height="800px">
        ...
        <PaginationTable ref="PaginationTableId" url="/GoodCollect/List" :column="dataColum">
            <template v-slot:header>
                ...
                <el-button type="danger" size="mini" icon="el-icon-delete" @click="ShowBatchDeleteModal()">批 量 删
                    除</el-button>
                <ExportButton :where="searchForm" exportUrl="/GoodCollect/Export"></ExportButton>
