<template>
    <div>
        ...
        <PaginationTable ref="PaginationTableId" url="/User/List" :column="dataColum" :where="where">
            ...
            <template v-slot:Operate="scope">
                ...
                <el-button type="danger" size="mini"  @click="ShowDeleteModal(scope.row.Id)" v-if="scope.row.RoleTypeFormat == '用户' && RoleType == '管理员'">删 除</el-button>
