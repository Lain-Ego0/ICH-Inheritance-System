<template>
    <div class="app-container">
        ...
        <el-dialog  :title="formData.Id ? '修改非遗文化类别' : '添加非遗文化类别'"   :visible.sync="editorShow" width="50%" :lock-scroll="true" height="800px">
        ...
        <PaginationTable ref="PaginationTableId" url="/CulturalType/List" :column="dataColum" :where="where">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/CulturalType/Get`, `/CulturalType/CreateOrEdit`, Id, title, data);
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/CulturalType/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/CulturalType/CreateOrEdit`, this.formData);
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/CulturalType/Delete`, { Id: Id });
       		   this.$refs.PaginationTableId.Reload(this.searchForm);
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/CulturalType/BatchDelete`, { Ids: ids });
