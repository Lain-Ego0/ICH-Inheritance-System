<template>
    <div class="app-container">
            ...
            <div class="tb-body">
                <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
                    ...
                    <el-form-item label="民族" prop="Nation">
                        <el-input v-model.trim="searchForm.Nation"  placeholder="请输入民族"  :clearable="true"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="出生年月">
                        <el-date-picker v-model="searchForm.BirthDateRange" type="daterange" start-placeholder="开始出生年月"
                            end-placeholder="结束出生年月" :default-time="['00:00:00']" value-format="yyyy-MM-dd HH:mm:ss ">
                        </el-date-picker>                                       
                    </el-form-item>                
        ...
        <el-dialog  :title="formData.Id ? '修改传人' : '添加传人'"   :visible.sync="editorShow" width="50%" :lock-scroll="true" height="800px">
            <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
                label-width="140px" size="mini">
                 <el-row :gutter="10" class="EditFromBody"   style="max-height: 600px;overflow-y: scroll"  >               
                    <el-col :span="24">
                        <el-form-item label="姓名" prop="Name">
                            <el-input type="text" v-model.trim="formData.Name"  placeholder="请输入姓名"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="编号" prop="No">
                    ...
                    <el-col :span="24">
                        <el-form-item label="出生年月" prop="BirthDate">
                            <el-date-picker v-model="formData.BirthDate" align="right" type="date" placeholder="选择时间" value-format="yyyy-MM-dd HH:mm:ss">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="性别" prop="Sex">
                            <el-input type="text" v-model.trim="formData.Sex"  placeholder="请输入性别"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="民族" prop="Nation">
                            <el-input type="text" v-model.trim="formData.Nation"  placeholder="请输入民族"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="省市区" prop="ProviceCityArea">
        ...
        <PaginationTable ref="PaginationTableId" url="/Inheritor/List" :column="dataColum" :where="where">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/Inheritor/Get`, `/Inheritor/CreateOrEdit`, Id, title, data);
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/Inheritor/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/Inheritor/CreateOrEdit`, this.formData);
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/Inheritor/Delete`, { Id: Id });
       		   this.$refs.PaginationTableId.Reload(this.searchForm);
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/Inheritor/BatchDelete`, { Ids: ids });
